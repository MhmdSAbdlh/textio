...
function engToAr(){
    ...
    if(document.getElementById("textArea").style.direction != "rtl"){
        ...
        document.getElementById('btn2').className = 'disabledBtn';
        document.getElementById('btn2').textContent = "Disabled";
    }
    else{
        ...
        document.getElementById('btn2').className = 'btns';
